<?php /* source file: /Users/jorismorger/longboardspots/chive/protected/views/routine/form.php */ ?>
<?php echo CHtml::form('', 'post', array('id' => CHtml::$idPrefix)); ?>
	...
	<?php /* line 7 */ $this->widget('SqlEditor', array('name'=>"query", 'value'=>"{$query}", 'width'=>"95%", 'height'=>"200px")); ?>
